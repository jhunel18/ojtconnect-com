                        ...
                        <Hidden lgUp>
                            <div style={{ display: 'flex', alignItems: 'center', marginLeft: 'auto', justifyContent: 'end' }}>
                                ...
                                <Menu
                                    ...
                                    <ScrollLink to='home_section' smooth={true} duration={1000}><MenuItem className='dropdown' onClick={handleMenuClose}>HOME</MenuItem></ScrollLink>
                                    <ScrollLink to='about_section' smooth={true} duration={1000}><MenuItem className='dropdown' onClick={handleMenuClose}>ABOUT</MenuItem></ScrollLink>
                                    <ScrollLink to='discover_section' smooth={true} duration={1000}><MenuItem className='dropdown' onClick={handleMenuClose}>DISCOVER</MenuItem></ScrollLink>
                                    <ScrollLink to='contact_section' smooth={true} duration={1000}><MenuItem className='dropdown' onClick={handleMenuClose}>CONTACT US</MenuItem></ScrollLink>
                                </Menu>
                            </div>
                        </Hidden>
                    </Grid>
